...
export const TruckIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    ...
    <path fillRule="evenodd" d="M11.25 3.321c.21-.309.584-.504.986-.504h4.396c.298 0 .584.116.792.324l1.63 1.632a.96.96 0 0 1 .282.68V14.25a.75.75 0 0 1-1.5 0V6.529l-1.072-1.072a.24.24 0 0 0-.17-.07H12.23a.24.24 0 0 0-.197.39l.01.013c.895 1.25.93 2.87.12 4.161-.403.642-1.02 1.11-1.745 1.344A3.753 3.753 0 0 1 12 14.25H3.75A2.25 2.25 0 0 1 1.5 12V5.25A2.25 2.25 0 0 1 3.75 3h6.51c.362.001.71.065 1.04.172l.001.002c.032.01.063.02.094.032.193.067.38.15.556.25l.001.001.001.001.002.001.005.003Z" clipRule="evenodd" />
  </svg>
);
...
export const UserPlusIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        <path d="M2.251 20.105a8.25 8.25 0 0 1 13.385-6.722 4.502 4.502 0 0 0-4.136 2.226 2.25 2.25 0 0 1-2.226 1.348H5.68a.75.75 0 0 0-.75.75 8.25 8.25 0 0 1-2.679 5.421A.75.75 0 0 1 2.251 20.105Z" />
        <path d="M18.75 13.5a.75.75 0 0 0-1.5 0v2.25h-2.25a.75.75 0 0 0 0 1.5h2.25v2.25a.75.75 0 0 0 1.5 0v-2.25h2.25a.75.75 0 0 0 0-1.5h-2.25v-2.25Z" />
    </svg>
);
